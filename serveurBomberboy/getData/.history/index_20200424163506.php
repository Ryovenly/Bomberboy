...
<?php
echo $utilisateur[0]['downControl'];
echo $utilisateur[0]['upControl'];
echo $utilisateur[0]['leftControl'];
echo $utilisateur[0]['rightControl'];
echo $utilisateur[0]['controlControl'];
?>
